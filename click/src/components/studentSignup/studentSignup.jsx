...
function Signup() {
    ...
    const {userId, password, passwordCheck} = data;
    ...
    return(
        <div>
            ...
            <p>* 도담도담 아이디</p>
            <input type="text"  name='userId' value={userId} onChange={onChangeInput} placeholder="아이디" className="inputId"></input><br/>
            <button type="submit" name="IdCheck" onClick={onClickIdCheck}>중복 확인</button><br />
            <p>* 도담도담 비밀번호</p>
            <input type="password" name='password' value={password} onChange={onChangeInput} placeholder="비밀번호" className="IdCheck"></input><br />
            <p>* 비밀번호 확인</p>
